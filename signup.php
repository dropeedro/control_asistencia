...
include('connect.php');
  ...
  try{
      ...
      if(isset($_POST['signup'])){
        ...
        $result = mysqli_query($conexion, "insert into admininfo(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
