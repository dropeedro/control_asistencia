...
declare namespace MindFusion.Scheduling
{
	...
	class Item
	{
		...
		constructor();
		/** Gets the string identificator of this item. */
		id: string;
		...
		contacts: MindFusion.Common.Collections.ObservableCollection;
		/** Gets the collection of resources associated with this item. */
		resources: MindFusion.Common.Collections.ObservableCollection;
	...
	class Recurrence
	{
		...
		exceptions: MindFusion.Common.Collections.Dictionary;
	...
	class TimetableSettings
	{
		...
		*/
		...
		dates: MindFusion.Common.Collections.ObservableCollection;
		/** Gets or sets the orientation of the view. */
		orientation: Orientation;
	...
	class Schedule
	{
		...
		*/
		...
		tasks: MindFusion.Common.Collections.ObservableCollection;
		/** Gets the collection of contacts in this schedule. */
		contacts: MindFusion.Common.Collections.ObservableCollection;
		/** Gets the collection of locations in this schedule. */
		locations: MindFusion.Common.Collections.ObservableCollection;
		...
		*/
		getAllItems(startTime: DateTime, endTime?: DateTime, resource?: Resource): MindFusion.Common.Collections.List;
		...
		changed: MindFusion.Common.EventDispatcher;
	...
	class Calendar extends UIControl
	{
		...
		*/
		...
		cells: MindFusion.Common.Collections.List;
		...
		*/
		...
		itemSelection: MindFusion.Common.Collections.ObservableCollection;
		...
		*/
		...
		/** Raised when the schedule is changed. */
		scheduleChanged: MindFusion.Common.EventDispatcher;
		/** Raised when the calendar date is changed. */
		visibleDateChanged: MindFusion.Common.EventDispatcher;
		/** Raised when a selection is started. */
		selectionStart: MindFusion.Common.EventDispatcher;
		/** Raised when a selection changes. */
		selectionChanged: MindFusion.Common.EventDispatcher;
		/** Raised when a selection has ended. */
		selectionEnd: MindFusion.Common.EventDispatcher;
		/** Raised while an item is being created. */
		itemCreating: MindFusion.Common.EventDispatcher;
		/** Raised when an item is created. */
		itemCreated: MindFusion.Common.EventDispatcher;
		/** Raised while an item is being modified. */
		itemModifying: MindFusion.Common.EventDispatcher;
		/** Raised when an item is modified. */
		itemModified: MindFusion.Common.EventDispatcher;
		/** Raised while an item is being deleted. */
		itemDeleting: MindFusion.Common.EventDispatcher;
		/** Raised when an item is deleted. */
		itemDeleted: MindFusion.Common.EventDispatcher;
		/** Raised while a recurring item is being deleted. */
		recurringItemDeleting: MindFusion.Common.EventDispatcher;
		/** Raised when an item remider is triggered. */
		itemReminderTriggered: MindFusion.Common.EventDispatcher;
		/** Raised when an task remider is triggered. */
		taskReminderTriggered: MindFusion.Common.EventDispatcher;
		...
		formShow: MindFusion.Common.EventDispatcher;
		/** Raised when a popup form is closed. */
		formClose: MindFusion.Common.EventDispatcher;
		...
		cellDoubleClick: MindFusion.Common.EventDispatcher;
		...
		headerDoubleClick: MindFusion.Common.EventDispatcher;
		/** Raised when an item cue is clicked. */
		cueClick: MindFusion.Common.EventDispatcher;
	}
	...
	class BaseForm
	{
		...
		*/
		...
		controls: MindFusion.Common.Collections.Dictionary;
	...
	class FormEventArgs extends MindFusion.Common.CancelEventArgs
	{
		/** Gets the form instance related to the event. */
		form: BaseForm;
	}
	/** Specifies data for the ButtonClick event. */
	class ButtonEventArgs extends MindFusion.Common.CancelEventArgs
	{
	...
	class HeaderEventArgs extends MindFusion.Common.EventArgs
	{
		/** Gets the type of the header related to the event. */
		type: HeaderType;
	}
	/** Specifies data for selection related events. */
	class SelectionEventArgs extends MindFusion.Common.CancelEventArgs
	{
	...
	class ItemModifyingEventArgs extends MindFusion.Common.CancelEventArgs
	{
		/** Gets the item related to the event. */
		item: Item;
	...
	class ItemModifiedEventArgs extends MindFusion.Common.EventArgs
	{
	...
	class TaskEventArgs extends MindFusion.Common.CancelEventArgs
	{
		/** Gets the task for which the event is raised. */
		task: Task;
	}
	/** Specifies data the VisibleDateChanged event. */
	class DateChangedEventArgs extends MindFusion.Common.EventArgs
	{
