...
try{
  ...
  $result = mysqli_query($conexion, "update students set st_name='$_POST[name]',st_dept='$_POST[dept]',st_batch='$_POST[batch]',st_sem='$_POST[semester]', st_email = '$_POST[email]' where st_id='$sid'");
...
<div class="row">
    <div class="content">
      ...
      //initializing student ID from form data
       ...
       $all_query = mysqli_query($conexion, "select * from students where students.st_id='$sr_id'");
