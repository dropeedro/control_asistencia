  ...
  <div class="content">
   ...
   <?php
    ...
    if(isset($_POST['sr_btn'])){
     ...
     $single = mysqli_query($conexion, "select * from reports where reports.st_id='$sr_id' and reports.course = '$course'");
    ...
    if(isset($_POST['sr_date'])){
     ...
     $all_query = mysqli_query($conexion, "select * from reports where reports.stat_date='$sdate' and reports.course = '$course'");
