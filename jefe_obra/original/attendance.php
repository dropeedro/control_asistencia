...
<?php
    ...
    if(isset($_POST['att'])){
      ...
      foreach ($_POST['st_status'] as $i => $st_status) {
        ...
        $stat = mysqli_query($conexion, "insert into attendance(stat_id,course,st_status,stat_date) values('$stat_id','$course','$st_status','$dp')");
  ...
  <div class="content">
    ...
    <form action="" method="post" class="form-horizontal col-md-6 col-md-offset-3">
     ...
     <div class="form-group">
                ...
                <select name="whichbatch" id="input1">
                      ...
                      <option name="seven" value="1">1</option>
                </select>
              </div>
   ...
   <?php
    ...
    if(isset($_POST['batch'])){
     ...
     $all_query = mysqli_query($conexion, "select * from students where st_batch='$batch' order by st_id asc");
