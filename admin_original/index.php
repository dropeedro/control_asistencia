  ...
  try{
    ...
    if(isset($_POST['std'])){
      ...
      //students data insertion to database table "students"
        $result = mysqli_query($conexion, "insert into students(st_id,st_name,st_dept,st_batch,st_sem,st_email) values('$_POST[st_id]','$_POST[st_name]','$_POST[st_dept]','$_POST[st_batch]','$_POST[st_sem]','$_POST[st_email]')");
        ...
        if(isset($_POST['tcr'])){
          ...
          $res = mysqli_query($conexion, "insert into teachers(tc_id,tc_name,tc_dept,tc_email,tc_course) values('$_POST[tc_id]','$_POST[tc_name]','$_POST[tc_dept]','$_POST[tc_email]','$_POST[tc_course]')");
